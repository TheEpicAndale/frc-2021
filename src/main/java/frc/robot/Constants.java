...
public final class Constants {
    ...
    public static final int RIGHT_MOTOR_MASTER = 5;
    ...
    public static final double MOUNTING_HEIGHT = 1.792;
    public static final double TARGET_HEIGHT = 4.0 / 12.0;
    ...
    public static final double FINAL_DISTANCE = 1.5; // 9/12 is 9 inches (9/12 feet)

    // finclell
    public static final double LOWER_BOUND = -25.0;
    public static final double UPPER_BOUND = 25.0;
    public static final double CERTAIN_SPEED = 0.3;
    ...
    public static final double FUNNEL_SPEED = 0.95;

    /*
     * Button Layout: https://lh3.googleusercontent.com/proxy/
     * 4yxUw9HDilB3aXxwCBah5cEqYzxUmfjy8SinOk6YDfjythu9zwu0d1L2G3VlhRRYZNajZn8tlqefoYg066u8VogdlhkxIhQerXLhNC6UfKqipMiXQ9LEgrzOlI8CB700HRklZMxHS5dCVwnkp2zQ0Q
     * 4 3 2 1
     * 
