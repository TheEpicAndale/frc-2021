...
import frc.robot.commands.FindCell;
import frc.robot.commands.RampDownFlywheel;
import frc.robot.commands.RunFlywheel;
import frc.robot.commands.ShootCell;
import frc.robot.commands.TestMoveCell;
...
import frc.robot.commands.TestStopIntake;
...
public class Robot extends TimedRobot {
    ...
    private FindCell findCell;
    private TestMoveCell testMoveCell;
    ...
    // public Button hoodInButton = new JoystickButton(joystick,
    // Constants.HOOD_IN_BUTTON);
    // public Button hoodOutButton = new JoystickButton(joystick,
    // Constants.HOOD_OUT_BUTTON);
    ...
    public void autonomousInit() {
        // findCell = new FindCell();
        // findCell.schedule();
        testMoveCell = new TestMoveCell();
        testMoveCell.schedule();
        // drivetrain.resetEncoder();
    }
    ...
    public void teleopInit() {
        ...
        intakeButton.whenPressed(new TestRunIntake());
        towerButton.whenPressed(new TestStopIntake());
        ...
        /**
         * testRunFlywheel = new TestRunFlywheel(); testRunFlywheel.schedule();
